...
const Consultation = () => {
  ...
  return ( 
      <div className="consNavContainer">
        ...
        <ConsNavComp imgUrl={Emergency} title={'Итно советување'} text={'Добивате консултација во рок од 15 минути од плаќањето, со јасни инструкции за спасување на вашето милениче додека да добиете професионална помош. Најпогодно во живото-загрозувачки ситуации додека да добиете пристап до ветеринар.'} navLocation={'/consultation/emergency'}/>
