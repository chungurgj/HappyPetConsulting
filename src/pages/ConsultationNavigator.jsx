...
const Consultation = () => {
  ...
  return ( 
      <div className="consNavContainer">
        <ConsNavComp imgUrl={Video} title={'Видео советување'} text={'Добивате детална консултација на вашето милениче преку видео повик, најпогодно кога ситуацијата не е живото-загрозувачка и немате пристап до добар ветеринар.'} navLocation={'/consultation/video'}/>
